export default {
  ...
  configuration_clear_option: 'Cancella la configurazione e ripristina l\'applicazione',
  ...
  auth_form_secrets_help_message: 'Tutte i dati sensibili verranno salvati in secure storage.',
  ...
  auth_external_heads_up: '❗️Se stai usando un provider di autenticazione esterno come Authelia, Keycloak, Cloudflare Tunnels, ecc. OAuth Clients non funziona. Puoi usare solo Personal Access Tokens.',
