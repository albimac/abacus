export default {
  ...
  configuration_about: 'Informazioni',
  configuration_clear_option: 'Ripristina configurazione iniziale',
  ...
  configuration_report_issue: 'Segnala un problema/bug',
  configuration_sources: 'Sorgenti',
  ...
  transaction_form_destinationAccount_label: 'Account destinazione',
  ...
  layout_new_update_body_text: 'Puoi sempre aggiornare dopo dal pannello di Impostazioni.',
  ...
  transaction_form_success_title: 'Riuscito',
  ...
  auth_external_heads_up: '❗️Se stai usando un provider di autenticazione esterno come Authelia, Keycloak, Cloudflare Tunnels, ecc. OAuth Clients non funziona. Puoi usare solo Personal Access Tokens only.',
